...
class MetadataFileSpec extends AnyFlatSpec with Matchers with EitherValues {
  ...
  "fromPath" should "parse path to regular metadata file" in {
    ...
    val path = new Path("hdfs://path/to/root/_spark_metadata/13")
  ...
  it should "parse path to .compact metadata file" in {
    ...
    val path = new Path("hdfs://path/to/root/_spark_metadata/4.compact")
  ...
  it should "return an error for invalid filename" in {
    ...
    val path = new Path("hdfs://path/to/root/_spark_metadata/foo.compact")
...
object MetadataFileSpec {
  ...
  val compactPaths = Seq(
    new Path("hdfs://path/to/root/_spark_metadata/7.compact"),
    new Path("hdfs://path/to/root/_spark_metadata/5.compact"),
    new Path("hdfs://path/to/root/_spark_metadata/9.compact"),
    new Path("hdfs://path/to/root/_spark_metadata/1.compact"),
    new Path("hdfs://path/to/root/_spark_metadata/3.compact")
  )

  val compactFiles = Seq(
    MetadataFile(1, compact = true, new Path("hdfs://path/to/root/_spark_metadata/1.compact")),
    MetadataFile(3, compact = true, new Path("hdfs://path/to/root/_spark_metadata/3.compact")),
    MetadataFile(5, compact = true, new Path("hdfs://path/to/root/_spark_metadata/5.compact")),
    MetadataFile(7, compact = true, new Path("hdfs://path/to/root/_spark_metadata/7.compact")),
    MetadataFile(9, compact = true, new Path("hdfs://path/to/root/_spark_metadata/9.compact"))
  )
  ...
  val combinedPaths = Seq(
    ...
    new Path("hdfs://path/to/root/_spark_metadata/3"),
    new Path("hdfs://path/to/root/_spark_metadata/2"),
    new Path("hdfs://path/to/root/_spark_metadata/10"),
    new Path("hdfs://path/to/root/_spark_metadata/1"),
    new Path("hdfs://path/to/root/_spark_metadata/9.compact"),
    new Path("hdfs://path/to/root/_spark_metadata/4"),
    new Path("hdfs://path/to/root/_spark_metadata/7"),
    new Path("hdfs://path/to/root/_spark_metadata/9"),
    new Path("hdfs://path/to/root/_spark_metadata/11"),
    new Path("hdfs://path/to/root/_spark_metadata/6"),
  ...
  val combinedFiles = Seq(
    ...
    MetadataFile(3, compact = true, new Path("hdfs://path/to/root/_spark_metadata/3.compact")),
    MetadataFile(4, compact = false, new Path("hdfs://path/to/root/_spark_metadata/4")),
    MetadataFile(5, compact = false, new Path("hdfs://path/to/root/_spark_metadata/5")),
    MetadataFile(6, compact = false, new Path("hdfs://path/to/root/_spark_metadata/6")),
    MetadataFile(6, compact = true, new Path("hdfs://path/to/root/_spark_metadata/6.compact")),
    MetadataFile(7, compact = false, new Path("hdfs://path/to/root/_spark_metadata/7")),
    MetadataFile(8, compact = false, new Path("hdfs://path/to/root/_spark_metadata/8")),
    MetadataFile(9, compact = false, new Path("hdfs://path/to/root/_spark_metadata/9")),
    MetadataFile(9, compact = true, new Path("hdfs://path/to/root/_spark_metadata/9.compact")),
    MetadataFile(10, compact = false, new Path("hdfs://path/to/root/_spark_metadata/10")),
    MetadataFile(11, compact = false, new Path("hdfs://path/to/root/_spark_metadata/11"))
  )
}
